...
public class Crawler {
    ...
    public static void main(String[] args) {
        try {
            Item.readCSV("C:\\Users\\Lukas\\my-eclipse-workspace\\TestProject\\src\\javaGame\\item.csv");
        } catch (IOException e) {
            System.out.println("Die item.csv kann nicht gelesen werden");
            return;
        }
        try {
            Quest.readCSV("C:\\Users\\Lukas\\my-eclipse-workspace\\TestProject\\src\\javaGame\\quest.csv");
        } catch (IOException e) {
